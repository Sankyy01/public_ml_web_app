...
diabeteas_model = pickle.load(open('Diabeteas_model.sav'))

heart_model = pickle.load(open('heart_model.sav'))

breast_cancer_model = pickle.load(open('breast_cancer_model.sav'))
